import{ab as s,B as d,C as a,A as i,N as e,I as t,ac as n,P as o}from"./app.7a1bdc2f.js";import"./vendor.fb97f350.js";const l={},c=n(`<h1 id="remark" tabindex="-1"><a class="header-anchor" href="#remark" aria-hidden="true">#</a> remark</h1><p>remark不单单是一个markdown的编译工具，更准确地说，它是一个围绕markdown的生态。通过插件化的方式，对mdast进行修改，使其转化成我们想要的样子。<code>remarkParse</code>就是将<code>markdown</code>编译为mdast的插件。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>import {unified} from &#39;unified&#39;
