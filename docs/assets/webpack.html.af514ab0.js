...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u4FEE\u6539<code>webpack()</code></p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>function webpack(options) {
  // \u5408\u5E76\u53C2\u6570 \u5F97\u5230\u5408\u5E76\u540E\u7684\u53C2\u6570 mergeOptions
  const mergeOptions = _mergeOptions(options);
  // \u521B\u5EFAcompiler\u5BF9\u8C61
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u8FD9\u6837\u6211\u4EEC\u5C31\u628A\u914D\u7F6E\u53C2\u6570\u5408\u5E76\uFF0C\u5E76\u4E14\u521B\u5EFA\u4E86\u4E00\u4E2Acompiler\u5BF9\u8C61\u4E86\u3002</p><h1 id="\u7F16\u8BD1\u51C6\u5907\u9636\u6BB5" tabindex="-1"><a class="header-anchor" href="#\u7F16\u8BD1\u51C6\u5907\u9636\u6BB5" aria-hidden="true">#</a> \u7F16\u8BD1\u51C6\u5907\u9636\u6BB5</h1><h2 id="\u7F16\u5199plugin" tabindex="-1"><a class="header-anchor" href="#\u7F16\u5199plugin" aria-hidden="true">#</a> \u7F16\u5199plugin</h2><p>\u5728\u7F16\u5199plugin\u4E4B\u524D\uFF0C\u5148\u5B8C\u5584\u4E00\u4E0Bcompiler\u7C7B</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>const { SyncHook } = require(&#39;tapable&#39;);
...
module.exports = Compiler;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u8FD9\u91CC\u5B9A\u4E49\u4E86<code>hooks</code> \uFF0C\u4F1A\u5728\u6253\u5305\u7684\u4E0D\u540C\u6D41\u7A0B\u65F6\u89E6\u53D1\uFF0C\u5F53\u6211\u4EEC\u901A\u8FC7<code>new SyncHook()</code>\u8FD4\u56DE\u4E00\u4E2A\u5BF9\u8C61\u5B9E\u4F8B\u540E\uFF0C\u6211\u4EEC\u53EF\u4EE5\u901A\u8FC7<code>this.hook.run.tap(&#39;name&#39;,callback)</code>\u65B9\u6CD5\u4E3A\u8FD9\u4E2A\u5BF9\u8C61\u4E0A\u6DFB\u52A0\u4E8B\u4EF6\u76D1\u542C\uFF0C\u7136\u540E\u5728\u901A\u8FC7<code>this.hook.run.call()</code>\u6267\u884C\u6240\u6709<code>tap</code>\u6CE8\u518C\u7684\u4E8B\u4EF6\u3002</p><p>\u73B0\u5728\u6211\u4EEC\u5148\u5207\u56DE<code>webpack.js</code></p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>const Compiler = require(&#39;./compiler&#39;);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u5728\u8FD9\u91CC\u6211\u4EEC\u5C31\u53EF\u4EE5\u5F88\u6E05\u695A\u7684\u660E\u767D\uFF0C\u5176\u5B9E<code>webpack</code>\u63D2\u4EF6<strong>\u672C\u8D28\u4E0A\u5C31\u662F\u901A\u8FC7\u53D1\u5E03\u8BA2\u9605\u7684\u6A21\u5F0F\uFF0C\u901A\u8FC7<code>compiler</code>\u4E0A\u76D1\u542C\u4E8B\u4EF6\u3002\u7136\u540E\u518D\u6253\u5305\u7F16\u8BD1\u8FC7\u7A0B\u4E2D\u89E6\u53D1\u76D1\u542C\u7684\u4E8B\u4EF6\u4ECE\u800C\u6DFB\u52A0\u4E00\u5B9A\u7684\u903B\u8F91\u5F71\u54CD\u6253\u5305\u7ED3\u679C</strong>\u3002</p><h2 id="\u5BFB\u627E\u5165\u53E3\u6587\u4EF6" tabindex="-1"><a class="header-anchor" href="#\u5BFB\u627E\u5165\u53E3\u6587\u4EF6" aria-hidden="true">#</a> \u5BFB\u627E\u5165\u53E3\u6587\u4EF6</h2><p>\u901A\u8FC7\u914D\u7F6E\u53C2\u6570\uFF0C\u83B7\u53D6\u5165\u53E3\u6587\u4EF6\u8DEF\u5F84\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>// compiler.js
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="\u5F00\u59CB\u7F16\u8BD1\u5165\u53E3\u6A21\u5757" tabindex="-1"><a class="header-anchor" href="#\u5F00\u59CB\u7F16\u8BD1\u5165\u53E3\u6A21\u5757" aria-hidden="true">#</a> \u5F00\u59CB\u7F16\u8BD1\u5165\u53E3\u6A21\u5757</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>class Compiler {
    // run\u65B9\u6CD5\u542F\u52A8\u7F16\u8BD1
  // \u540C\u65F6run\u65B9\u6CD5\u63A5\u53D7\u5916\u90E8\u4F20\u9012\u7684callback
  run(callback) {
    // \u5F53\u8C03\u7528run\u65B9\u5F0F\u65F6 \u89E6\u53D1\u5F00\u59CB\u7F16\u8BD1\u7684plugin
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u4F7F\u7528loader\u5904\u7406\u6587\u4EF6" tabindex="-1"><a class="header-anchor" href="#\u4F7F\u7528loader\u5904\u7406\u6587\u4EF6" aria-hidden="true">#</a> \u4F7F\u7528loader\u5904\u7406\u6587\u4EF6</h3><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>// \u6A21\u5757\u7F16\u8BD1\u65B9\u6CD5
  buildModule(moduleName, modulePath) {
    // 1. \u8BFB\u53D6\u6587\u4EF6\u539F\u59CB\u4EE3\u7801
    const originSourceCode =
      ((this.originSourceCode = fs.readFileSync(modulePath)), &#39;utf-8&#39;);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u8FD9\u91CC<code>module.js</code> \u88AB\u5F15\u7528\u4E86\u4E24\u6B21\uFF0C\u5BF9<code>handleWebpackCompiler</code>\u8FDB\u884C\u4E00\u4E0B\u4F18\u5316</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>    handleWebpackCompiler(moduleName, modulePath) {
       ...
        // \u901A\u8FC7babel\u4FEE\u6539\u6E90\u4EE3\u7801\u4E2D\u7684require\u53D8\u6210__webpack_require__\u8BED\u53E5
          node.callee = t.identifier(&#39;__webpack_require__&#39;);
          // \u4FEE\u6539\u6E90\u4EE3\u7801\u4E2Drequire\u8BED\u53E5\u5F15\u5165\u7684\u6A21\u5757 \u5168\u90E8\u4FEE\u6539\u53D8\u4E3A\u76F8\u5BF9\u4E8E\u8DDF\u8DEF\u5F84\u6765\u5904\u7406
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u5173\u6CE8<code>buildUpChunk</code> \u65B9\u6CD5\uFF0Cchunk\u662F\u4E00\u4E2A\u5BF9\u8C61\uFF0C\u5305\u62EC\u5165\u53E3\u6587\u4EF6\u7684\u540D\u79F0\uFF0C\u5165\u53E3\u6587\u4EF6\u7F16\u8BD1\u540E\u7684\u5BF9\u8C61\u548C\u5176\u4F9D\u8D56\u7684\u6A21\u5757</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>Set {
  {
    name: &#39;main&#39;,
    entryModule: {
      id: &#39;./example/src/entry1.js&#39;,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>exportFile</code>\u65B9\u6CD5</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>// \u5C06chunk\u52A0\u5165\u8F93\u51FA\u5217\u8868\u4E2D\u53BB
  exportFile(callback) {
